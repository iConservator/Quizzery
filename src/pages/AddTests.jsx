...
export default function AddTests() {
  ...
  const addAnswer = (qIndex) => {
    const updated = [...parsedTests];
    updated[qIndex].answers.push({ label: String.fromCharCode(65 + updated[qIndex].answers.length), text: 'Ваша відповідь' });
    setParsedTests(updated);
  };
              ...
              {editIndex === i ? (
                <>
                  ...
                  <textarea
                    ...
                    style={{ width: '100%', fontWeight: 'bold', fontSize: '1.1rem', marginBottom: '1rem', resize: 'vertical' }}
                  />
                ...
                <>
                  ...
                  <strong style={{ marginBottom: '1rem', display: 'block' }}>{q.number}. {q.question}</strong>
                    ...
                    {q.answers.map((a, j) => (
                      <button
                        ...
                        style={{
                          ...baseBtn,
                          backgroundColor: q.correctIndex === j ? '#d4edda' : '#f9f9f9',
                          borderColor: q.correctIndex === j ? '#28a745' : '#ccc',
                        }}
                      >
